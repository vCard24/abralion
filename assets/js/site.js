...
function initFooterSocial() {
  ...
  if (!desc || desc.parentElement.querySelector('.footer-social')) {
    return;
  }
  ...
  desc.insertAdjacentElement('afterend', ul);
}

if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', initFooterSocial);
} else {
  initFooterSocial();
}
