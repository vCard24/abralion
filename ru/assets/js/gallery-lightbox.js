...
(function () {
  ...
  function ensureDialog() {
    ...
    dialog.setAttribute('aria-label', typeof t === 'function' ? t('gallery.dialog') : 'gallery.dialog');
    dialog.innerHTML = `
      <div class="gallery-lightbox__inner">
        <button type="button" class="gallery-lightbox__close" aria-label="${typeof t === 'function' ? t('gallery.close') : 'gallery.close'}">×</button>
        <button type="button" class="gallery-lightbox__nav gallery-lightbox__nav--prev" aria-label="${typeof t === 'function' ? t('gallery.previous') : 'gallery.previous'}">‹</button>
        ...
        <button type="button" class="gallery-lightbox__nav gallery-lightbox__nav--next" aria-label="${typeof t === 'function' ? t('gallery.next') : 'gallery.next'}">›</button>
      </div>`;
  ...
  function bindGalleryTriggers() {
    ...
    if (container) {
      ...
      container.setAttribute('aria-label', typeof t === 'function' ? t('gallery.enlarge') : 'gallery.enlarge');
